...
- [**multi-persona-fleet**](./multi-persona-fleet): Fleet patterns for running Hermes & OpenClaw sandboxes with warm pools, JIT persona injection, and scalability optimizations.
